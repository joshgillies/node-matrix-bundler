...
function FileBundle (opts) {
  ...
  this._add = function add () {
    return bundler.add.apply(bundler, arguments)
  }
  this._createBundle = function createBundle () {
    return bundler.createBundle.apply(bundler, arguments)
  }
